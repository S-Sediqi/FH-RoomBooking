...
public class UserRegAdmin_UI extends JFrame implements ActionListener {
    ...
    public UserRegAdmin_UI() {
        ...
        datetime_Lb.setLocation(670, 30);
        c.add(datetime_Lb);
        ...
        userSettingBt = new JButton("User Setting");
        userSettingBt.setFont(new Font("Arial", Font.PLAIN, 15));
        userSettingBt.setSize(300, 20);
        userSettingBt.setLocation(500, 450);
        userSettingBt.setFocusable(false);
        userSettingBt.addActionListener(this);
        c.add(userSettingBt);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == userSettingBt) {
            new UserSetting_UI();
            dispose();
        }
